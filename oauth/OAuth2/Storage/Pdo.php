    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    public function setAccessToken($access_token, $client_id, $user_id, $expires, $scope = null)
    {
        ...
        //start 本地多余设置一次全域cookie，主要是兼容checkUserLogin 中的cookie记录账号 的处理
        setcookie(Yii::$app->params['main_domain_cookie_name'], $access_token, time()+3600*24*30, '/', Yii::$app->params['main_domain_cookie']);
        //end
        // if it exists, update it.
