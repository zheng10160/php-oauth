...
class AccessToken implements AccessTokenInterface
{
     ...
     *         'access_lifetime' => 1209600,          // time before access token expires
     *         'refresh_token_lifetime' => 7776000, // time before refresh token expires
     *     );
     * @endcode
     */
    public function __construct(AccessTokenStorageInterface $tokenStorage, RefreshTokenInterface $refreshStorage = null, array $config = array())
    {
        ...
        $this->config = array_merge(array(
            'token_type'             => 'bearer',
            'access_lifetime'        => 2592000,//30
            'refresh_token_lifetime' => 7776000,//3个月
        ), $config);
    }
